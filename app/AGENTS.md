...
- `GET /radio/host-repeater/stats` (includes `region_gate`: level, max level, budget use, closed regions; `tx`: sent, airtime, errors, table full, queued, in flight, drops by cause), `POST /radio/host-repeater/stats/reset`
